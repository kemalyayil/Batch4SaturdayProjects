...
public class Address {
   ...
   It assigns the parameter to the instance variable 'address1'
    ...
    public String City(String myCity){
        ...
        return cityList.contains(myCity)? this.city = myCity : "We are not able to ship to your location";
    }
    ...
    public String ZipCode(String myZipcode){
        ...
        return (myZipcode.length() == 5)? this.zipCode = myZipcode : "Zip code length should be 5";
    }
}
