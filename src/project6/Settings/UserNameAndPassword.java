...
public class UserNameAndPassword {
   ...
   /*
        ...
        Create an Arraylist . Arraylist type should be String. ArrayList should be static and private .
        Name is UserNameLists
     */
    ...
    */
    ...
    /*
       Create a constructor whose parameters are String Username , String Password.
    ...
    */
    ...
    /*
        Create a method whose name is setUsername
    ...
    */
    ...
    /*
    Create a method whose name is setPassword
    Return type is String
    ...
    public String setPassword(String myPassword){
        ...
        return (myPassword.length() <= 5)? "Password length more then 5 character" : (password = myPassword);
    }
