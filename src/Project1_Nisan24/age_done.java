...
public class age_done {

     /*
        Given an int ,
            if the Project1.age less then and equal 10
                print  "too young to create a Facebook account"

             if the Project1.age less then and equal 16
                print  "too young to get a driver's license"

             if the Project1.age less then and equal 18
                print  "too young to get a tattoo"

            if the Project1.age less then and equal 21
